...
namespace UnityEngine.GameFoundation
{
    ...
    {
        /// <summary>
        ///     The list of <see cref="CatalogItem"/> this catalog stores.
        /// </summary>
        internal Dictionary<string, CatalogItem> m_Items = new Dictionary<string, CatalogItem>();
            ...
            where TCatalogItem : CatalogItem
        {
            ...
            {
                if (item is TCatalogItem typedItem && item.key.Equals(key))
                {
                    return typedItem;
                }
            }
