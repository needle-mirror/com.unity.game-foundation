...
{
    [ExcludeFromDocs]
    partial class WalletManagerImpl
    {
        /// <summary>
        ...
        /// </summary>
        Dictionary<Currency, long> m_Balances = new Dictionary<Currency, long>();

        /// <summary>
        ///     Accessor to GameFoundation's current DAL.
        /// </summary>
        IWalletDataLayer dataLayer => GameFoundationSdk.dataLayer;
        ...
        internal void Initialize()
        {
            ...
            catch (Exception e)
            {
                ...
                throw new Exception($"{nameof(WalletManagerImpl)}: failed to initialize data", e);
            }
        }
        ...
        ///     For each currency available in the current catalog, it gets the persisted player balance, or set it to 0.
        /// </summary>
        void InitializeData()
        {
