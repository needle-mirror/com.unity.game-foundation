...
namespace UnityEngine.GameFoundation
{
    ...
    /// </summary>
    [ExcludeFromDocs]
    partial class InventoryManagerImpl
    {
        /// <summary>
        ...
        /// <summary>
        ///     Initializes this manager using GameFoundation's <see cref="GameFoundationSdk.dataLayer"/> and
        ///     <see cref="GameFoundationSdk.catalog"/>.
        /// </summary>
        public void Initialize()
        {
            ...
            {
                Uninitialize();
                throw new Exception($"{nameof(InventoryManagerImpl)} failed to initialize data", e);
            }
        }

        /// <summary>
        ///     Uninitializes this manager by discarding all managed items and resetting all fields.
        /// </summary>
        ...
        /// <summary>
        ///     Parses GameFoundation's data layer's data to fill this manager.
        /// </summary>
        void InitializeData()
        {
        ...
        /// </param>
        internal void SyncCreateItem(string key, string id) => dataLayer.CreateItem(key, id, Completer.None);
