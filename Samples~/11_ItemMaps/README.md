README - Game Foundation Sample Scenes - Item Maps

In this example, you will see how to add and remove items from Item Maps.
All code can be found within the "ItemMapsSample" script.
...
* In this scene you'll notice the "ItemMapsCatalog" is set in the Override Catalog Asset field in the GameFoundationInit component.
...
* To do that, you will need to set your GameFoundationCatalogSettings to point to the ItemMapsCatalog found in the 10_ItemMaps directory, where this README is located.
