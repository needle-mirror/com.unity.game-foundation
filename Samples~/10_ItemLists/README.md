README - Game Foundation Sample Scenes - Item Lists

In this example, you will see how to add and remove items from Item Lists.
All code can be found within the "ItemListsSample" script.
...
* In this scene you'll notice the "ItemListsCatalog" is set in the Override Catalog Asset field in the GameFoundationInit component.
...
* To do that, you will need to set your GameFoundationCatalogSettings to point to the ItemListsCatalog found in the 10_ItemLists directory, where this README is located.
